...
- (void)addTag:(NSArray *)arguments webView:(UIWebView *)webView{
      NSLog(@"333");
     NSString *arg0 = [arguments objectAtIndex:0];
...
- (void)delTag:(NSArray *)arguments webView:(UIWebView *)webView{
...
- (void)listTag:(NSArray *)arguments webView:(UIWebView *)webView{
...
- (void)addAlias:(NSArray *)arguments webView:(UIWebView *)webView{
    NSString *arg0 = [arguments objectAtIndex:0];
...
- (void)delAlias:(NSArray *)arguments webView:(UIWebView *)webView{
    NSString *arg0 = [arguments objectAtIndex:0];
    NSString *arg1 = [arguments objectAtIndex:1];
    NSString *cb = [arguments objectAtIndex:2];
...
- (void)setAlias:(NSArray *)arguments webView:(UIWebView *)webView{
    NSString *arg0 = [arguments objectAtIndex:0];
    NSString *arg1 = [arguments objectAtIndex:1];
    NSString *cb = [arguments objectAtIndex:2];
...
- (void)handleAliasResult:(NSInteger)retCode  callbackFunction:(NSString *)function webView:(UIWebView *)webView
{
